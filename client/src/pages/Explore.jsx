...
const Explore = () => {
  ...
  const filteredProblems = problems
    ...
    .sort((a, b) => {
      ...
      // HIGHEST BOUNTY FIRST (paid only)
      if (filters.sortBy === "bounty") {
        return (b.bounty || 0) - (a.bounty || 0);
      }

      // FREE FIRST, THEN NEWEST
      if (filters.sortBy === "free-first") {
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              ...
              >
                ...
                <option value="free-first">Free First (Newest)</option>
              </select>
            </div>
      ...
      <div className="max-w-8xl mx-auto px-6 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto px-4">
          {filteredProblems.map((problem) => (
            <div
              key={problem._id}
              className="group bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-200 hover:border-gray-300"
            >
              ...
              <div className="p-5 border-b border-gray-100">
                <div className="flex flex-wrap gap-2">
                  {problem.tags?.slice(0, 3).map((tag, idx) => (
                    <span
                      key={idx}
                      className="text-xs font-medium px-3 py-1.5 bg-gray-50 text-gray-700 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
                  {problem.tags && problem.tags.length > 3 && (
                    <span className="text-xs font-medium px-3 py-1.5 bg-gray-50 text-gray-500 rounded-lg">
              ...
              <div className="p-5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-violet-500 flex items-center justify-center text-white font-semibold uppercase shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {problem.type === "paid" ? "Sponsor" : "Community"}
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
                      problem.type === "paid"
                        ...
                        : "bg-blue-700 hover:bg-black text-white"
                    }`}
                  >
                    {problem.type === "paid" ? "View Bounty" : "Solve Problem"}
                  </button>
                </div>
              </div>
            </div>
